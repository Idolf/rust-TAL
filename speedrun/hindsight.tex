...
\todo{Insert reference to appendix, with example how to use our decidable equality}

\section{Predicates on Lists}
\todo{Write about predicates on lists}
All, AllZip, lookup, update and variants.

\section{Using records to emulate type-classes}
\todo{Write about records-as-type-classes}

\section{Experiments with the MixFix parser}
\todo{Write about the mix-fix-parser}

\section{Something about decidable propositions}
Include something about \texttt{dec-force}.
\todo{Write something about decidable propositions}
