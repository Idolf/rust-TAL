...
Vec-SubtypeSubstitution A {S} {S⁺} {ST} {{SS}} n = subtypeSubstitution xs-subtype-weaken xs-subtype-subst-exists
...
List-SubtypeSubstitution A {S} {S⁺} {ST} {{SS}} = subtypeSubstitution xs-subtype-weaken xs-subtype-subst-exists
...
instance
  ...
  Type-SubtypeSubstitution = subtypeSubstitution τ-subtype-weaken τ-subtype-subst-exists

  TypeVec-SubtypeSubstitution : ∀ {m} → SubtypeSubstitution (Vec Type m)
  TypeVec-SubtypeSubstitution = subtypeSubstitution regs-subtype-weaken regs-subtype-subst-exists
  ...
  InitType-SubtypeSubstitution = subtypeSubstitution τ⁻-subtype-weaken τ⁻-subtype-subst-exists
  ...
  InitTypeList-SubtypeSubstitution = subtypeSubstitution τs⁻-subtype-weaken τs⁻-subtype-subst-exists

  StackType-SubtypeSubstitution : SubtypeSubstitution StackType
  StackType-SubtypeSubstitution = subtypeSubstitution σ-subtype-weaken σ-subtype-subst-exists

  RegisterAssignment-SubtypeSubstitution :
    SubtypeSubstitution RegisterAssignment
  RegisterAssignment-SubtypeSubstitution = subtypeSubstitution Γ-subtype-weaken Γ-subtype-subst-exists
