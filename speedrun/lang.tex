...
\begin{lemma}
  ...
  \item If $\high P, \high P', \high P''$ are a program states and we have both
    ...
    $\high{P'} = \high{P''}$.\footnote{This equality refers to syntactic
      equality. See \cref{sec:equality} for notes on this equality.}
...
\begin{lemma}
  ...
  \item If $\simple P, \simple{P'}, \simple{P''}$ are a program states and we
    ...
    $\simple{P'} = \simple{P''}$.\footnote{This equality refers to syntactic
      equality. See \cref{sec:equality} for notes on this equality.}
