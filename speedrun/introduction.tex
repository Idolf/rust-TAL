...
Anti-virus software is inherently limited by Rice's Theorem.\todo{Footnote:
  Rice's Theorem more generally states that ..., for a more thorough
  introduction see ...} This theorem implies that any attempt to classify
...
increasing it.\todo{Footnote: Snide comment about and reference to project-zero
  lulz}
