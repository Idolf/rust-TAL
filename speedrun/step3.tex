...
$\infer{
  ...
  \steps{\simple\running(\simple G, \simple P)}{\simple\running(\simple G, \simple P')}
}$ &
$\infer{
  \execis{\high G}{\high P}{\high P'}
}{
  \steps{\high\running(\high G, \high P)}{\high\running(\high G, \high P')}
}$ \\&\\
$\infer{ }{
  \steps{\simple\running(\simple G, \simple H, \simple R, \mathtt{halt})}{\simple\halted}
}$ &
$\infer{ }{
  \steps{\high\running(\high G, \high H, \high R, \mathtt{halt})}{\high\halted}
}$ \\&\\
$\infer{ }{
