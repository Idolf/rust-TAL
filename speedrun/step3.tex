...
\begin{mathpar}
\fbox{$\simple\lang \simpleo{->} \simple\lang$} \\
\infer{
...
\begin{mathpar}
\fbox{$\high\lang \higho{->} \high\lang$} \\
\infer{
...
\infer{
  ...
  \phantom{WWW}\high I_1 = \high I[x_1 / a_1] \and \Gamma_1 = \Gamma[x_1 / a_1]\phantom{WWW} \\
  \phantom{WWWWWWWWW}\vdots\phantom{WWWWWWWWW} \\
  \text{(this should be interpreted as recursively substituting $a_k$ with $x_k$ inside the values)} \\
  \phantom{WWWWWWWWW}\vdots\phantom{WWWWWWWWW} \\
  \high I_n = \high I_{n-1}[x_n / a_n] \and \Gamma_n = \Gamma_{n-1}[x_n / a_n] \\
}{
